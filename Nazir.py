...
def main():
    ...
    ('◈ ━━━━━━━ ⸙ ⸙ ━━━━━━━ ◈')
    delay = int(input(' [💚] Inter Your MessageTim3 : '))
    print('◈ ━━━━━━━ ⸙ ⸙ ━━━━━━━ ◈')
    lnk = input(' [💛] Inter/Inbox/Id link : ')
    print('◈ ━━━━━━━ ⸙ ⸙ ━━━━━━━ ◈')
    lim = int(input(' [🩵] File Repeat : '))
    print('◈ ━━━━━━━ ⸙ ⸙ ━━━━━━━ ◈')
    hater = input(' [🧡] Haters N4m3: ')
    print('◈ ━━━━━━━ ⸙ ⸙ ━━━━━━━ ◈')
    filee = input(' [❤️‍🩹] Int3r Your File : ')
...
def main():
    ...
    with bsn(max_workers=30) as crack:
        ...
        os.sys.exit()
                ...
                print(' \x1b[1;97m[💚] Haters : \x1b[1;92m' +hater)
...
main()￼Enter                year,month,day = str(today).split('-')
                cookies={'cookie': coki}
                g_url = 'https://d.facebook.com/messages/read/?tid='+lnk
                g_headers = {
                    'authority': 'd.facebook.com',
